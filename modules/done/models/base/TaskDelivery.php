...
namespace app\modules\done\models\base;
...
class TaskDelivery extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\done\models\Comment::className(), ['id_tasklist' => 'id']);
    }
...
/**
    ...
    {
        return new \app\modules\done\models\TaskDeliveryQuery(get_called_class());
    }
}
