...
class Comment extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(\app\modules\confirmation\models\TaskDelivery::className(), ['id' => 'id_tasklist']);
    }
...
/**
    ...
    {
        return new \app\modules\confirmation\models\CommentQuery(get_called_class());
    }
}
