...
namespace app\modules\confirmation\models\base;
...
class TaskDelivery extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['issue','data_comment'], 'string', 'max' => 800],
    ...
    {
        return $this->hasMany(\app\modules\confirmation\models\Comment::className(), ['id_tasklist' => 'id']);
    }
...
/**
    ...
    {
        return new \app\modules\confirmation\models\TaskDeliveryQuery(get_called_class());
    }
}
