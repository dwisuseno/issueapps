...
class MPic extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\datamaster\models\TaskDelivery::className(), ['id_pic' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\datamaster\models\MPicQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\datamaster\models\MPicQuery(get_called_class());
    }
}
