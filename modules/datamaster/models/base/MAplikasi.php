...
class MAplikasi extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\datamaster\models\TaskDelivery::className(), ['id_aplikasi' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\datamaster\models\MAplikasiQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\datamaster\models\MAplikasiQuery(get_called_class());
    }
}
