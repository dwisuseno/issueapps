...
class MStatus extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\datamaster\models\TaskDelivery::className(), ['id_status' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\datamaster\models\MStatusQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\datamaster\models\MStatusQuery(get_called_class());
    }
}
