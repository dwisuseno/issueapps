...
class TaskDelivery extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\backlog\models\Comment::className(), ['id_tasklist' => 'id']);
    }
...
/**
    ...
    {
        return new \app\modules\backlog\models\TaskDeliveryQuery(get_called_class());
    }
}
