...
<div class="dsis-system-user-form">
    ...
    <?= $form->field($model, 'role_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\modules\system\models\DsisSystemRole::find()->orderBy('id')->asArray()->all(), 'id', 'name'),
    ...
    <?= $form->field($model, 'dept_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\DsisMasterDepartment::find()->orderBy('id')->asArray()->all(), 'id', 'name'),
