...
class MPlatform extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\system\models\TaskDelivery::className(), ['id_platform' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\system\models\MPlatformQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\system\models\MPlatformQuery(get_called_class());
    }
}
