...
class MPrioritas extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\system\models\TaskDelivery::className(), ['id_prioritas' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\system\models\MPrioritasQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\system\models\MPrioritasQuery(get_called_class());
    }
}
