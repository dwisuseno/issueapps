...
class MSprint extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\system\models\TaskDelivery::className(), ['id_sprint' => 'id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\system\models\MSprintQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\system\models\MSprintQuery(get_called_class());
    }
}
